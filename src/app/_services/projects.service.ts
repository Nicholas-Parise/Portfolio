...
export class ProjectsService {
  ...
  projects: Project[] = [
    {id:0,name: 'Video Editor Interface', summary: 'A Video editor interface to demonstrate proper UI/UX design', description: 'description',projectLink: 'https://github.com/Nicholas-Parise/Video-Editor-Interface',date: 'April 20 2024',pictures: ['../../assets/Editor/VideoEditor.png','../../assets/Editor/HomePage.png']},
    {id:1,name: 'Traffic Simulator', summary: 'An indepth java project that has AI driven cars navigate roads trying not to crash', description: 'description',projectLink: 'https://github.com/Nicholas-Parise/traffic-Simulator',date: 'April 18 2024',pictures: ['../../assets/traffic.png','picture2']},
    {id:2,name: 'Brock Navigation App', summary: 'An android based google maps inspired campus navigation app', description: 'description',projectLink: 'https://github.com/Nicholas-Parise/Brock-Navigation',date: 'April 15 2024',pictures: ['../../assets/Navigation/image001.png','../../assets/Navigation/image002.png']},
