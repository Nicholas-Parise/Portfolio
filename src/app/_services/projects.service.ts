...
export class ProjectsService {
  ...
  projects: Project[] = [
    ...
    { name: 'Tetris', summary: 'A java Jpanel clone of classic Tetris', description: 'description', projectLink: 'https://github.com/Nicholas-Parise/Tetris-Java', liveLink: null, date: 'January 2021', pictures: ['../../assets/projects/tetris.png'], skills: [this.skillsService.GetSkillByName("Java")] },
    { name: 'Galaga', summary: 'Galaga Flash game I made in highschool', description: 'description', projectLink: null, liveLink: '/games', date: 'January 2018', pictures: ['../../assets/projects/galaga.png'], skills: [] }
  ];
