...
export class ProjectsService {
  ...
  projects: Project[] = [
    ...
    {id:5,name: 'Pacman', summary: 'A C++ SFML Pacman clone, with elements of other games', description: 'description',projectLink: 'https://github.com/Nicholas-Parise/PacMan',date: 'June 15 2024',pictures: ['../../assets/Pacman.png','picture2']},
    {id:6,name: 'Tetris', summary: 'A java Jpanel game made to learn about graphics in java', description: 'description',projectLink: 'https://github.com/Nicholas-Parise/Tetris-Java',date: 'January 13 2024',pictures: ['../../assets/tetris.png','picture2']}
