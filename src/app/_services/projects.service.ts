...
export class ProjectsService {
  ...
  GetSkillByName(name: string): Project {
  ...
  getRandom(): Project {
    return this.projects[Math.floor(Math.random() * (this.projects.length - 1))];
  }
}
