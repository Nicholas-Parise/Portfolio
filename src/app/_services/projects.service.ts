...
export class ProjectsService {
  ...
  projects: Project[] = [
    ...
    { name: 'Deglazd', summary: 'Full stack angular restaurant rating app', description: 'Full stack angular restaurant rating app', projectLink: null, liveLink: 'https://deglazd.com', date: 'April 2026', pictures: ['../../assets/projects/Deglazd.png'], skills: [this.skillsService.GetSkillByName("Angular"), this.skillsService.GetSkillByName("Docker"), this.skillsService.GetSkillByName("Node js"), this.skillsService.GetSkillByName("PSQL")] },
